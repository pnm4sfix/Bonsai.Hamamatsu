...
namespace Hamamatsu.DCAM4
{
    ...
    class dcambuf
    {
        ...
        public static DCAMERR attach(IntPtr hdcam, ref DCAMBUF_ATTACH aAttach)
        {
            return dcamapidll.dcambuf_attach(hdcam, ref aAttach);
        }
    ...
    class dcamcap
    {
        ...
        {
            return dcamapidll.dcamcap_record(hdcam, hdcamrec); //record
        }
    }
